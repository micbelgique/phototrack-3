...
namespace Trasys.Dev.Tools.Apps
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        /// </summary>
        /// <param name="parameter">Parameter to set in the target page</param>
        /// <typeparam name="TTarget">Target page</typeparam>
        public virtual void NavigateTo<TTarget>(object parameter) where TTarget : global::Windows.UI.Xaml.Controls.Page
        {
            if (this.Frame != null)
            {
                Type type = typeof(TTarget);
                this.Frame.Navigate(type, parameter);
            }
        }
        ...
        /// Navigate to the specified page
        /// </summary>
        public virtual void NavigateTo<TTarget>() where TTarget : global::Windows.UI.Xaml.Controls.Page
        {
            this.NavigateTo<TTarget>(null);
        }
        ...
        /// <param name="parameter">Parameter to set in the target page</param>
        /// <typeparam name="TTarget">Target page</typeparam>
        public static void NavigateToPage<TTarget>(object parameter) where TTarget : global::Windows.UI.Xaml.Controls.Page
        {
        ...
        public static void NavigateToPage<TTarget>() where TTarget : global::Windows.UI.Xaml.Controls.Page
        {
            NavigateToPage<TTarget>(null);
        }
